// Igual (==) // comparação não recomendada
// Retorna vardadeiro caso os operandos sejam iguais. 3 == var1
'3' == var1;
3 == '3';
...
// Estritamente igual (===) // comparação recomendada
// Retorna verdadeiro caso os operandos sejam iguais e do mesmo tipo. Veja também Object.is e igualdade
3 === var1;

// Estritamente não igual (!==)
// Retorna verdadeiro caso os operados não sejam iguais e/ou não sejam do mesmo tipo.
var1 !== '3';
3 !== '3';
